...
[DOC](https://docs.github.com/ru/authentication/connecting-to-github-with-ssh/adding-a-new-ssh-key-to-your-github-account)

Подлинность SSH-ключа: [SSH](https://clck.ru/3B9Z3W)
...
``` origin	https://github.com/%Имя_аккаунта%/%Имя_проекта%.git (fetch)```<br>
``` origin	https://github.com/%Имя_аккаунта%/%Имя_проекта%.git (push)```<br>
...
В README.md проекта можно найти:
...
README.md - текстовый файл, который можно создать командой ```touch```, а затем редактировать так же, как и любой другой текстовый документ.<br>

Преимущества: могут отображать его содержимое в браузере в виде удобной разметки.<br>

Для этого нужно не просто залить текст, но и настроить шифр, заголовки и отступы с помощью markdown.

## **8. Заключение**

Git - полезный инструмент для работы c файлами.
